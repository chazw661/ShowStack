...
- [x] 09-04-PLAN.md — JS orphan render hook + node-mode inspector with Re-link/Delete + canvas lockout + human-verify checkpoint for all 5 success criteria (Wave 3, depends on 01+02+03) — SHP-06, SHP-07
