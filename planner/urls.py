...
from .views import (
     ...
     audio_checklist_move_task,
     audio_checklist_set_days,
...
urlpatterns = [
    ...
    path('admin/planner/commcrewname/import/', 
     ...
     path('comm-config/session/add/', views.comm_config_add_session, name='comm_config_add_session'),
     path('comm-config/session/update/', views.comm_config_update_session, name='comm_config_update_session'),
     path('comm-config/session/delete/', views.comm_config_delete_session, name='comm_config_delete_session'),
     path('comm-config/roleset/add/', views.comm_config_add_roleset, name='comm_config_add_roleset'),
     path('comm-config/roleset/update/', views.comm_config_update_roleset, name='comm_config_update_roleset'),
     path('comm-config/roleset/delete/', views.comm_config_delete_roleset, name='comm_config_delete_roleset'),
     path('comm-config/crew-name/add/', views.comm_config_add_crew_name, name='comm_config_add_crew_name'),
     path('comm-config/crew-name/delete/', views.comm_config_delete_crew_name, name='comm_config_delete_crew_name'),
     path('comm-config/dante/add/', views.comm_config_add_dante, name='comm_config_add_dante'),
     path('comm-config/dante/update/', views.comm_config_update_dante, name='comm_config_update_dante'),
     path('comm-config/dante/delete/', views.comm_config_delete_dante, name='comm_config_delete_dante'),
...
# near your other API routes:
 ...
 #-------IP Address Module---
    ...
    #-------Checklist------
     ...
     path('audiochecklist/move-task/', audio_checklist_move_task, name='audio_checklist_move_task'),
     path('audiochecklist/set-days/', audio_checklist_set_days, name='audio_checklist_set_days'),
